...
I'm an aspiring **Data Analyst** passionate about turning raw data into actionable insights. Recently completed a comprehensive 5-month Data Science program from **Naresh IT, Hyderabad**.
...
### 🏨 [Hotel Booking Cancellation Analysis](https://github.com/yourusername/hotel-booking-analysis)
Analyzed 119K hotel bookings to identify cancellation drivers, revealing potential $6.8M revenue recovery opportunity.  
**Tech Stack:** Python, Pandas, Matplotlib, Seaborn  
**Key Finding:** Deposit policies reduce cancellations by 98%

### 📈 [Sales Forecasting Dashboard](https://github.com/yourusername/sales-forecasting)
Built interactive dashboard for sales trend analysis and forecasting.  
**Tech Stack:** Python, Tableau, SQL  

### 🛒 [Customer Segmentation Analysis](https://github.com/yourusername/customer-segmentation)
Performed RFM analysis and clustering to identify customer segments.  
